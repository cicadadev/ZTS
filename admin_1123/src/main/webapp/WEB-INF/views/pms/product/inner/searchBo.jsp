...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring"%>
	<tr>
		...
		<th rowspan="3" class="alignL"><spring:message code="pms.product.list.productid" /></th>
		<td rowspan="3">
	...
	<tr>
		<th>상품유형</th>
		<td><checkbox-list ng-model="search.productType" custom="PRODUCT_TYPE" all-check ></checkbox-list></td>
		<th>담당MD ID/명</th>
		<td >
		...
		<th rowspan="3" class="alignL"><spring:message code="c.pms.sendgoods.saleproductNo" /><%--단품ID --%></th>
		<td rowspan="3">
			<textarea cols="30" rows="5" placeholder="" ng-model="search.saleproductId" search-area style="height:auto;"></textarea>
		</td>
	</tr>
	<tr>
		...
		<th>공급업체 번호/명</th>
		<td >
			<input type="text" value="" ng-model="search.businessId" style="width:30%;" />
			<input type="text" value="" ng-model="search.businessName" style="width:30%;" />
	...
	<tr>
		...
		<th>상품 ERP 코드</th>
		<td>
			<input type="text" value="" ng-model="search.erpProductId" style="width:80%;" />
		</td>
	</tr>