...
<div class="wrap_popup con_box" ng-app="productListApp" data-ng-controller="bulkUploadCtrl as ctrl">
	...
	<div class="box_type1">
		...
		<div class="btn_alignC" style="margin-top: 20px;">
			<button type="button" class="btn_type3 btn_type3_purple" data-ng-click="ctrl.checkExcel()">
				<b><spring:message code="c.pmsProductreserve.batchUpload" /></b><%-- 일괄 업로드 --%>
			</button>
		</div>
	</div>
	<%-- 이미지 일괄업로드 --%>
	<div class="box_type1" style="margin-top: 50px;" ng-if="bulkType=='3'">
		<table class="tb_type1">
			<colgroup>
				<col width="16%" />
				<col width="*%" />
			...
			<tbody>
				<tr>
					<th>이미지 일괄등록</th><%-- 등록 파일선택 --%>
					<td>
						<div class="input_file">
							<input type="file" excel-upload id="img"  />
							<input type="text" placeholder="업로드할 파일을 선택해 주세요." ng-model="filePath" style="width: 300px;"/>
							<button type="button" class="btn_type2 btn_addFile">
								<b><spring:message code="c.common.file.search" /></b><%-- 찾아보기 --%>
							</button>
		...
		<div class="btn_alignC" style="margin-top: 20px;">
			<button type="button" class="btn_type3 btn_type3_purple" data-ng-click="ctrl.checkImg()">
				<b><spring:message code="c.pmsProductreserve.batchUpload" /></b><%-- 일괄 업로드 --%>
			</button>
		</div>
	</div>
