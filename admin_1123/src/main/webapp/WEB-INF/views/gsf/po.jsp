...
<body data-ng-app="mainApp">
	<div class="wrap">
		...
		<div id="main" class="header_group" ng-controller="poController as mainCtrl" ng-init="mainCtrl.detail('${loginInfo.businessId}')">
		
			<header>
				<h1 class="po_logo">
					<a href="/main" data-ng-click="mainCtrl.main()">INTUNE GCP 2.0 PARTNER OFFICE</a>
				</h1>

				<ul class="guide">
					<li>
						<a href="#none">업무담당자 안내</a>
					</li>
					<li>
						<a href="#none">입점약관보기</a>
					</li>
					<li>
						<a href="#none" data-ng-click="mainCtrl.menualDown()">메뉴얼 다운</a>
					</li>
				</ul>
				<div class="user_box">
					<b class="user_id">${loginInfo.loginName}</b>
					
					<a href="#none" class="btn_type4" data-ng-click="mainCtrl.openMember('${loginInfo.loginId}')">
						<b>정보변경</b>
					</a>
		...
		<section class="content">
			...
			<article class="con_box con_on"  id="pages">
				<iframe src="/ccs/pomain" name='__pageSpan' id='mainpo' frameborder="0" onLoad='calcHeight(this.id);' style='width:100%;'></iframe>
			</article>
			</div>
