...
<div class="wrap_popup"  ng-app="memberManagerApp" data-ng-controller="mms_memberOnlineOrderPopApp_controller as ctrl">
			...
			<table class="tb_type1">
				...
				<tbody>
					...
					<tr>
						<th>주문번호</th>
						<td>
							<input type="text" data-ng-model="search.orderId" placeholder="" style="width:45%;" />
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="box_type1 marginT3">
			<h3 class="sub_title2">
				주문정보내역<!-- 주문 정보 내역 -->
				<span><spring:message code="c.search.totalCount" arguments="{{ grid_memberOnlineOrder.totalItems }}" /></span>
			</h3>
			
			<div class="gridbox gridbox300">
				<div class="grid" data-ui-grid="grid_memberOnlineOrder" 
