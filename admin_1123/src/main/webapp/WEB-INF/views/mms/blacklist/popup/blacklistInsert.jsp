...
<div class="wrap_popup"  ng-app="blacklistManagerApp" data-ng-controller="mms_blacklistInsertPopApp_controller as ctrl">
		<h1 class="sub_title1">블랙리스트 등록<!-- 블랙리스트 등록 --></h1>
			...
			<table class="tb_type1">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input data-ng-init="mmsBlacklist.userid=''" data-ng-model="mmsBlacklist.userid" id="userid" type="text" name="userid" placeholder="" style="width:20%;" readonly disabled required/>
							<input data-ng-model="mmsBlacklist.name" id="name" type="text" name="name" placeholder="" style="width:20%;" readonly disabled/>
							<button type="button" class="btn_type2" data-ng-click="searchMember()"><b><spring:message code="c.search.btn.search"/><!-- 검색 --></b></button>
							<button type="button" class="btn_eraser" ng-class="{'btn_eraser_disabled' : mmsBlacklist.userid == null || mmsBlacklist.userid == ''}" ng-click="ctrl.delText()"></button>
							<p class="information" ng-show="blacklistInsertForm.memberNo.$error.required"><spring:message code="c.common.invalid.content"/> <!-- 필수 입력 항목 입니다. --></p>
						</td>
						<th>
							회원상태<!-- 회원상태 -->
						</th>
