...
<div class="wrap_popup"  ng-app="exhibitApp" data-ng-controller="dms_exhibitMainProductInsertPopApp_controller as ctrl">
		<h1 class="sub_title1"><spring:message code="c.dmsExhibitproduct.regMainProduct" /><!-- 대표상품 등록 --></h1>
			...
			<table class="tb_type1">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input data-ng-init="dmsExhibitMainProduct.productId=''" data-ng-model="dmsExhibitMainProduct.productId" id="productId" type="text" name="productId" placeholder="" style="width:20%;" readonly disabled required/>
							<input data-ng-model="dmsExhibitMainProduct.productName" id="name" type="text" name="name" placeholder="" style="width:20%;" readonly disabled/>
							...
							<p class="information" ng-show="mainProductInsertForm.productId.$error.required"><spring:message code="c.common.invalid.content"/> <!-- 필수 입력 항목 입니다. --></p>
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr class="column2">
						...
						<td colspan="3">
							...
							<div class="preview" ng-if="dmsExhibitMainProduct.img">
								<img ng-src="dmsExhibitMainProduct.img" img-domain onError="this.src='/resources/img/bg/bg_temp_img.gif';" alt="">
