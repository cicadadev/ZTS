...
<script type="text/javascript" src="/resources/js/app/oms.app.partner.shipping.js"></script>
...
<article class="con_box" ng-app="partnerShippingApp" ng-controller="listCtrl as ctrl" data-ng-init="ctrl.init()">
	<h2 class="sub_title1"><spring:message code="c.oms.logistics.partner.shipping.process"><!-- 출고완료처리_협력사 --></spring:message></h2>
	<div class="box_type1">
	...
	<div class="btn_alignR marginT3">
		<button type="button" class="btn_type1" ng-click="ctrl.bulk.upload.excel()" fn-id="84_INSERT">
			<b><spring:message code="c.oms.logistics.invoice.shipping.all.reg" /></b>
		</button>
	...
	<div class="box_type1 marginT1">
		<h3 class="sub_title2">
			...
			<span><spring:message code="c.search.totalCount" arguments="{{ grid_partnerShipping.totalItems }}" /></span>
		</h3>
		<div class="tb_util tb_util_rePosition">
			<button type="button" class="btn_tb_util tb_util1" ng-click="myGrid.initGrid()">되돌리기</button>
			<button type="button" class="btn_tb_util tb_util2" ng-click="myGrid.exportExcel()" fn-id="84_EXCEL">엑셀받기</button>
		</div>
		<div class="gridbox">
			<div class="grid" data-ui-grid="grid_partnerShipping" 
