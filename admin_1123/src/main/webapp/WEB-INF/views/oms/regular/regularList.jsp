...
<script type="text/javascript" src="/resources/js/app/oms.app.regular.list.js"></script>

<article class="con_box con_on" ng-app="regularListApp" ng-controller="listCtrl as ctrl">
	<!-- ### 주문 조회 ### -->
	<h2 class="sub_title1">
		<spring:message code="c.oms.regular.search" />
	</h2>
	<div class="box_type1">
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<div class="day_group" start-ng-model="search.startDate" end-ng-model="search.endDate" date-only forward calendar-button="A" init-button="0"/>
					</td>
				</tr>
				<tr>
					<th>신청자</th>
	...
	<div class="box_type1 marginT1">
		<h3 class="sub_title2">
			<spring:message code="c.oms.regular.list" /><%-- 주문 목록 --%>
			<span><spring:message code="c.search.totalCount" arguments="{{ grid_regular.totalItems }}" /></span>
		</h3>
		<div class="gridbox">
			<div class="grid" ui-grid="grid_regular" 
