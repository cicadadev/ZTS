<%--
	화면명 : 주문 관리 > 주문업로드설정 > 주문업로드설정 등록 팝업
	작성자 : peter
 --%>
...
<div class="wrap_popup" ng-app="uploadConfApp" ng-cloak ng-controller="oms_uploadConfInsPopApp_controller as ctrl" >
	<h1 class="sub_title1"><spring:message code="c.oms.uploadconf.insertTitle" /></h1>
<form name="frmUploadconfInsert" >
	<div class="box_type1">
		<table class="tb_type1">
			...
			<tbody>
				<tr>
					...
					<td>
						<select ng-model="omsUploadconf.siteId" ng-options="site.siteId as site.name for (idx, site) in siteList track by site.siteId">
							<option value="">선택하세요</option><!-- 전체 -->
						</select>
					</td>
...
※ 전화번호, 휴대폰번호, 우편번호와 같이 한 개인 항목이 제휴사에서는 두 개 이상의 항목으로 관리되는 경우 ‘항목1&항목2’로 표현해야 합니다.<br />
	...
	<div class="btn_alignC marginT3">
		...
		<button type="button" class="btn_type3 btn_type3_purple" data-ng-click="ctrl.saveNewUploadconf()">
