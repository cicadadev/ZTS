...
<div class="inner eventWrap">
				...
				<div class="psCardWrap">
					<ul class="pscTab">
						...
						<li class="active"><a href="/sps/event/card?cno=3" class=""><img src="/resources/img/pc/event/partnershipCard/psCard_tab03.png" alt="롯데카드 롯데국민행복카드"></a></li>
					...
					<div class="pscCont contArea03">
						<div class="pscTxtD pscTxt01">
							<span class="img_pc"><img src="/resources/img/pc/event/partnershipCard/psCard_img03_01.png" alt="롯데 국민행복카드"></span>
							<span class="img_mc"><img src="/resources/img/mobile/event/partnershipCard/psCard_img03_01.png" alt="롯데 국민행복카드"></span>
							
							<!-- btn area begin -->
							<a href="https://www.lottecard.co.kr/app/IHEVNAA_V200.top?evn_bult_seq=2576" class="btnDef btn_psc01" target="_self"><img src="/resources/img/pc/event/partnershipCard/pscCont03_btn01.png" alt="롯데국민행복카드 카드신청"></a>
							<!-- // btn area end -->
						</div>
						<div class="pscTxtD pscTxt02">
							<span class="img_pc"><img src="/resources/img/pc/event/partnershipCard/psCard_img03_02.png" alt="1. 5% 청구할인 혜택 
2. VIP 멤버십 혜택
3. 바우처 별 혜택
4. BC 카드 혜택"></span>
							<span class="img_mc"><img src="/resources/img/mobile/event/partnershipCard/psCard_img03_02.png" alt="1. 5% 청구할인 혜택 
2. VIP 멤버십 혜택
3. 바우처 별 혜택
4. BC 카드 혜택"></span>
							<!-- btn area begin -->
	...
	<jsp:include page="/WEB-INF/views/sps/event/inner/cardNoLayer.jsp" flush="false">
		<jsp:param value="${cno }" name="cardType"/>
				<jsp:param value="롯데 국민행복카드" name="cardName"/>
	</jsp:include>		
