...
<div class="inner eventWrap">
				...
				<div class="psCardWrap">
					<ul class="pscTab">
						...
						<li class="active"><a href="/sps/event/card?cno=2" class=""><img src="/resources/img/pc/event/partnershipCard/psCard_tab02.png" alt="비씨카드 BC국민행복카드"></a></li>
					...
					<div class="pscCont contArea02">
						<div class="pscTxtD pscTxt01">
							<span class="img_pc"><img src="/resources/img/pc/event/partnershipCard/psCard_img02_01.png" alt="BC 국민행복카드"></span>
							<span class="img_mc"><img src="/resources/img/mobile/event/partnershipCard/psCard_img02_01.png" alt="BC 국민행복카드"></span>
						</div>
						<div class="pscTxtD pscTxt02">
							<span class="img_pc"><img src="/resources/img/pc/event/partnershipCard/psCard_img02_02.png" alt="1. 최대 5% 할인 혜택
2. VIP 멤버십 혜택
3. 바우처 별 혜택
4. BC 카드 혜택"></span>
							<span class="img_mc"><img src="/resources/img/mobile/event/partnershipCard/psCard_img02_02.png" alt="1. 최대 5% 할인 혜택
2. VIP 멤버십 혜택
3. 바우처 별 혜택
4. BC 카드 혜택"></span>
							<!-- btn area begin -->
							...
							<a href="#none" onclick="viewLayer(openCardLayer);" class="btnDef btn_psc02" target="_self">
	...
	<jsp:include page="/WEB-INF/views/sps/event/inner/cardNoLayer.jsp" flush="false">
		...
		<jsp:param value="BC 국민행복카드" name="cardName"/>
	</jsp:include>		
