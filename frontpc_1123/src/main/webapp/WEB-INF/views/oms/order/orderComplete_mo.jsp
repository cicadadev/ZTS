									...
									<div class="tr_box">
										<div class="col1">
											<div class="positionR">
												...
												<strong class="itemPrice"><fmt:formatNumber value="${os.totalSalePrice }" pattern="#,###"/>원</strong>																		
											</div>
											${presentNames }
...
<%-- 													<a href="javascript:oms.printReceipt('${pay.orderId }','${pay.pgApprovalNo }')">영수증출력</a> --%>
<%-- 													<a href="javascript:oms.printCashReceipt('${pay.orderId }','${pay.pgApprovalNo }')">현금영수증출력</a> --%>
												</c:when>
			...
			<div class="btn_wrapC btn2ea">
				...
				<a href="/mms/mypage/order/general/${omsOrder.orderId}" class="btn_bStyle1 sPurple1">주문상세보기</a>
			</div>
