...
<c:forEach var="cp" varStatus="idx2" items="${claim.omsClaimproducts}">
	<c:if test="${fn:contains('ORDER_PRODUCT_TYPE_CD.GENERAL,ORDER_PRODUCT_TYPE_CD.SET,ORDER_PRODUCT_TYPE_CD.WRAP', cp.omsOrderproduct.orderProductTypeCd)}">
			...
			<div class="col1 rowspan">
				<div class="cell">
					<div class="vAlign orderNum">
						...
						<a href="/mms/mypage/claim/regular/${claim.orderId}/${claim.claimNo}">상세보기</a>
