...
$(document).ready(function() {
	...
	$("[name=lookbook_detailLink]").on("click", function() {
		...
		if (ccs.common.mobilecheck()) {
			brand.template.lookbookDetail(id, name, mainSwiper_body);
		} else {
			brand.template.lookbookDetail(id, name);
		}
...
<div class="lookbook">
	...
	<c:if test="${isMobile ne 'true'}">
		<div class="sortingR">
			<div class="select_box1">
				<label>시즌/년도</label>
				<select id="seasonSelect" onchange="brand.template.seasonSelect();">
	...
	<div id="catalogue_detail_pc"></div>
