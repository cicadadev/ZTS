...
@Data
public class SearchPagingTag extends RequestContextAwareTag {
...
//	private String 		type;           // [옵션] : ajax
	...
	public String getOptionStr(){
		return "pageSize:" + pageSize + ",callback:" + callback;
	}
	@Override
	protected int doStartTagInternal() throws Exception {
		...
		if(total > 0){
			...
			for (int i = startPage; i <= endPage; i++) {
				...
				if(currentPage != i){
					sb.append("<a href=\"#none\" onclick=\"common.goSearchPage('currentPage:"+i+"," + getOptionStr() + "');\">");
					sb.append(i);
					sb.append("</a>");
				}else{
					sb.append("<strong>");
	...
	private String getFirstLink() {
		return "<a href=\"javascript:void(0);\" onclick=\"common.goSearchPage('currentPage:1," + getOptionStr() + "');\" class=\"btn first\">처음</a>";
	}

	private String getPrevLink() {
		String button = "";
		if (currentPage > perPageNavi) {
			button = "<a href=\"javascript:void(0);\" onclick=\"common.goSearchPage('currentPage:" + (startPage - 10) + "," + getOptionStr()
					+ "');\" class=\"btn prev\">이전</a>";
	...
	private String getNextLink() {
		...
		if (std < 1) {
			button = "<a href=\"javascript:void(0);\" onclick=\"common.goSearchPage('currentPage:" + (endPage + 1) + "," + getOptionStr()
					+ "');\" class=\"btn next\">다음</a>";
		} else if (std >= 1) {
	...
	private String getLastLink() {
		return "<a href=\"javascript:void(0);\" onclick=\"common.goSearchPage('currentPage:" + maxPage + "," + getOptionStr() + "');\" class=\"btn last\">마지막</a>";
	}
	
//	private String getFirstLink() {
//		if(currentPage > 1) {
//			return "<a href=\"#none\" onclick=\"common.goSearchPage('currentPage:1," + getOptionStr() + "');\" class=\"btn first\">처음</a>";
//		}else{
//			//return "<a href=\"#none\" class=\"btn first\">처음</a>";
//			return "";
//		}
//	}
//	
...
//		
//		if(currentPage > 1) {
//			return "<a href=\"#none\" onclick=\"common.goSearchPage('currentPage:" + (currentPage - 1) + "," + getOptionStr()
//					+ "');\" class=\"btn prev\">이전</a>";
//		}else{
//			return "<a href=\"#none\" class=\"btn prev\">이전</a>";
//		}
//		
//	}
//	
...
//					+ "');\" class=\"btn next\">다음</a>";
//		}else{
//			return "<a href=\"#none\"  class=\"btn next\">다음</a>";
//		}
//		
//	}
//	
...
//		
//		if(endPage < maxPage) {
//			return "<a href=\"#none\" onclick=\"common.goSearchPage('currentPage:" + (endPage + 1) + "," + getOptionStr()
//					+ "');\" class=\"btn last\">마지막</a>";
//		}else{
////			return "<a href=\"#none\" class=\"btn last\">마지막</a>";
//			return "";
//		}
//		
//	}
